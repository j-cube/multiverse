...
SET( ALEMBIC_SQLITE3_INCLUDE_PATH ${SQLITE3_INCLUDE_DIRS} )
SET( ALEMBIC_SQLITE3_LIBS ${SQLITE3_LIBRARIES} )

IF (SQLITE3_FOUND)
  MESSAGE( STATUS "SQLITE3 INCLUDE PATH: ${ALEMBIC_SQLITE3_INCLUDE_PATH}" )
  MESSAGE( STATUS "SQLITE3 LIBRARIES: ${ALEMBIC_SQLITE3_LIBS}" )
ENDIF()
